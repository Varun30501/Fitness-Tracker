    ...
    const fetchUserData = () => {
        if (user) {
            setFormData({
                ...
                dailyCalorieIntake: user?.dailyCalorieIntake || 200,
        ...
        dark:text-white">Profile</h1>
            ...
            <div className="profile-content">
                ...
                <Card>
                    ...
                    from-emerald-400 to-emerald-600 flex items-center
                    justify-center">
                            <User className="size-6 text-white" />
                        </div>
                        <div>
                            <h2 className="text-lg font-semibold text-slate-800
                        dark:text-white">Your Profile</h2>
                    ...
                    {isEditing ? (
                        ...
                        duration-200">
                                    <div className="size-10 rounded-lg bg-blue-100
                        ...
                        duration-200">
                            ...
                            dark:bg-purple-900/20 flex items-center justify-center">
                                        <Scale className="size-4.5 text-purple-600
                                dark:text-purple-400"/>
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-500
                                dark:text-slate-400">Weight</p>
                                        <p>{user.weight} kg</p>
                                    </div>
                                </div>
                        ...
                        duration-200">
                            ...
                            dark:bg-green-900/20 flex items-center justify-center">
                                            <User className="size-4.5 text-green-600
                                dark:text-green-400"/>
                                        </div>
                                        <div>
                                            <p className="text-sm text-slate-500
                                dark:text-slate-400">Height</p>
                                            <p>{user.height} cm</p>
                                        </div>
                                    </div>
                                )}
                        ...
                        duration-200">
                            ...
                            dark:bg-orange-900/20 flex items-center justify-center">

...
const Dashboard = () => {
    ...
    // console.log("Food Logs:", allFoodLogs);
    // console.log("Activity Logs:", allActivityLogs);
    // console.log("Today:", new Date().toISOString().split("T")[0])
    // console.log("Food Dates:", allFoodLogs.map(log => log.date))
    // console.log("Activity Dates:", allActivityLogs.map(log => log.date))
            ...
            < div className="dashboard-grid" >
                ...
                < Card className="shadow-lg col-span-2" >
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 rounded-xl bg-orange-100 flex
                    ...
                    <ProgressBar value={totalBurned} max={user?.dailyCalorieBurn
                        || 400} />
                </Card >
                    ...
                    user && user.weight && (
                        <Card>
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-12 h-12 rounded-xl bg-indigo-100 flex
                    items-center justify-center">
                                    <ScaleIcon className="w-6 h-6 text-indigo-500" />
                                </div>
                                <div>
                                    <h3 className="font-semibold text-slate-800
                        dark:text-white">Body Metrics</h3>
                            ...
                            dark:text-slate-400">Weight</span>
                                    </div>
                        ...
                        dark:text-slate-200">{user.weight} kg</span>
                            ...
                            dark:bg-slate-800">
                                            ...
                                            <span className="text-sm text-slate-500
                            dark:text-slate-400">Height</span>
                                        </div>
                                        <span className="font-semibold text-slate-700
                ...
                <Card>
                    <h3 className="font-semibold text-slate-800 
                    dark:text-white mb-4">Today's Summary</h3>
